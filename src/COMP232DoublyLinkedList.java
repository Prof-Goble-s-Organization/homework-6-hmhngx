/**
 * Doubly linked list implementation of the COMP232List interface.
 * 
 * @author Grant Braught
 * @author Dickinson College
 * 
 */
public class COMP232DoublyLinkedList<E> implements COMP232List<E> {
	 ...
	 */
	public COMP232DoublyLinkedList() {
		/*
	 ...
	 *             if list is empty.
	 */
	public void addAllAt(int index, COMP232DoublyLinkedList<E> list)
			throws IndexOutOfBoundsException {
