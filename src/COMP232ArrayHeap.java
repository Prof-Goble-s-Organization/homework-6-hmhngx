/**
 * Implementation of the COMP232PriorityQueue interface that uses a binary heap
...
public class COMP232ArrayHeap<K extends Comparable<K>, V> implements COMP232PriorityQueue<K, V> {
	 ...
	 * keys and values are rearranged into an order the forms a valid heap using
	 * the O(n) heapify algorithm.
	 * 
	 * @param keys
	 *            the keys
	 * @param values
